...
const Page = () => {
    ...
    useEffect(() => { request() }, [])
    return <>
        <PaginatedTable error={error} isLoading={loading} title="Classrooms" columns={["Name", "Capacity", "Type", "Department", "Actions"]} data={toRow(data)} actions={[{ name: "Create Classroom", link: "/app/admin/create-classroom" }]} />
    </>
